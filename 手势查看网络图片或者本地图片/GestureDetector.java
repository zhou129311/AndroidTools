...
public class GestureDetector {
	 ...
	 * 
	 * @deprecated Use
	 *             {@link #GestureDetector(Context, android.view.GestureDetector.OnGestureListener, Handler)}
	 *             instead.
	 */
	@Deprecated
	 ...
	 * 
	 * @deprecated Use
	 *             {@link #GestureDetector(Context, android.view.GestureDetector.OnGestureListener)}
	 *             instead.
	 */
	@Deprecated
