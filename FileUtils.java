...
public class FileUtils {
	...
	public static long getSDCardAvailableSize(){
		...
		if(isSDCardAvailable()){
			StatFs stat = new StatFs(getSaveFilePath());
	 ...
	 */
	public static boolean checkVersion(String version) throws PackageManager.NameNotFoundException {
	 ...
	 * @return 校验结果
	 */
	public static boolean verifyMD5(String fileMD5,File file){
		String md5;
		md5 = ByteUtils.getFileMD5(file);
	...
	public static String getSaveFilePath(){
		...
		if(isSDCardAvailable()){
			file = new File(Environment.getExternalStorageDirectory()
					.getAbsolutePath() + File.separator +"patron");
			if(!file.exists() || !file.isDirectory()){
				file.mkdirs();
			}
		}else{
			file = new File(File.separator +"patron");
			if(!file.exists() || !file.isDirectory()){
				file.mkdirs();
			}
		}
