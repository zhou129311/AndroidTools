...
public class MyLog {
    ...
    private static String MYLOG_PATH_SDCARD_DIR="/sdcard/patron/";// 日志文件在sdcard中的路径
    private static int SDCARD_LOG_FILE_SAVE_DAYS = 0;// sd卡中日志文件的最多保存天数
    private static String MYLOGFILEName = "helper_log.txt";// 本类输出的日志文件名称
    ...
    private static void writeLogtoFile(String mylogtype, String tag, String text) {// 新建或打开日志文件
        ...
        File logFile = new File(MYLOG_PATH_SDCARD_DIR, needWriteFiel
                + MYLOGFILEName);
        try {
